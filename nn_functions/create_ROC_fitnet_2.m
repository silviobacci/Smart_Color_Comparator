function [net, accuracy_e, neurons_e, best_n] = create_ROC_fitnet_2(input, targets, hn_min, hn_max, hn_step, trains, hn_min2, hn_max2, hn_step2)
    %% Create the waitbar
