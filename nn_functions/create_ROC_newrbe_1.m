function [net, accuracy_n, neurons, best_n] = create_ROC_newrbe_1(input, targets, hn_min, hn_max, hn_step, trains)
    %% Create the waitbar
    ...
    for hn = hn_min : hn_step : hn_max
        ...
        for i = 1 : trains
            ...
            [centres, out_centres, spread(i)] = random_spread(input_train, targets_train, hn, i); 
